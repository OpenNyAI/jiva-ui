...
const ClearActivityDialog: React.FC<ClearSearchDialogProps> = ({handleClose, open, handleClearSearch, isClearing}) => (
	<div>
		<BootstrapDialog
			onClose={handleClose}
		...
		>
			...
			<DialogContent>
                ...
                This will permanently remove all the activities you have performed on this platform permanently.
				</Typography>
			</DialogContent>
			<DialogActions>
...
export default ClearActivityDialog;
